...
src_file = "/experiments/agajbhiye/deepQuestPY/deepQuest-py/datasets/z_mean_balanced_et_en_data/test/test.src" 
mt_file = "/experiments/agajbhiye/deepQuestPY/deepQuest-py/datasets/z_mean_balanced_et_en_data/test/test.mt"
...
def main():
    ...
    with open ("/experiments/agajbhiye/deepQuestPY/deepQuest-py/datasets/z_mean_balanced_et_en_data/test/test.tpred", "w") as f:
