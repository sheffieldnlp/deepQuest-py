...
src_file = "/experiments/agajbhiye/deepQuest-py/datasets/classification/et_en_mlqe/test/test.src" 
mt_file = "/experiments/agajbhiye/deepQuest-py/datasets/classification/et_en_mlqe/test/test.mt"
...
def main():
    ...
    with open ("/experiments/agajbhiye/deepQuest-py/datasets/classification/et_en_mlqe/test/test.tpred", "w") as f:
